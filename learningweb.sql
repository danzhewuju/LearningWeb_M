-- --------------------------------------------------------
-- 主机:                           127.0.0.1
-- 服务器版本:                        5.5.56 - MySQL Community Server (GPL)
-- 服务器操作系统:                      Win64
...
-- 正在导出表  learningweb.administrator 的数据：~2 rows (大约)
...
-- 导出  表 learningweb.association 结构
...
-- 正在导出表  learningweb.association 的数据：~10 rows (大约)
/*!40000 ALTER TABLE `association` DISABLE KEYS */;
INSERT INTO `association` (`id`, `chapterid`, `prochapterid`) VALUES
	('1', '2', '1'),
	('10', '11', '9'),
	('2', '6', '2'),
	('3', '6', '3'),
...
-- 正在导出表  learningweb.chapter 的数据：~11 rows (大约)
/*!40000 ALTER TABLE `chapter` DISABLE KEYS */;
INSERT INTO `chapter` (`id`, `name`, `courseid`, `number`) VALUES
	('1', '线性表', '1', '1'),
	('10', '内部排序', '1', '10'),
	('11', '外部排序', '1', '11'),
	('2', '链表', '1', '2'),
...
-- 正在导出表  learningweb.course 的数据：~14 rows (大约)
/*!40000 ALTER TABLE `course` DISABLE KEYS */;
INSERT INTO `course` (`id`, `name`, `teacherid`, `picture`, `introduction`, `kind`) VALUES
...
-- 正在导出表  learningweb.data 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `data` DISABLE KEYS */;
INSERT INTO `data` (`id`, `name`, `address`, `chapterid`, `kind`) VALUES
	('1', '链表', '/data/链表.mp4', '2', '视频'),
	('2', '链表ppt', '/data/链表.html', '2', 'ppt');
/*!40000 ALTER TABLE `data` ENABLE KEYS */;

-- 导出  表 learningweb.exam 结构
...
-- 正在导出表  learningweb.exam 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `exam` DISABLE KEYS */;
/*!40000 ALTER TABLE `exam` ENABLE KEYS */;

-- 导出  表 learningweb.learn 结构
...
-- 正在导出表  learningweb.learn 的数据：~6 rows (大约)
/*!40000 ALTER TABLE `learn` DISABLE KEYS */;
INSERT INTO `learn` (`id`, `studentid`, `courseid`) VALUES
	('1', '1', '1'),
	('2', '2', '5'),
	('3', '3', '11'),
	('4', '1', '13'),
	('40288c81614a77b301614a784e9c0000', '2', '1'),
	('5', '4', '5');
/*!40000 ALTER TABLE `learn` ENABLE KEYS */;

-- 导出  表 learningweb.progress 结构
...
-- 正在导出表  learningweb.progress 的数据：~3 rows (大约)
/*!40000 ALTER TABLE `progress` DISABLE KEYS */;
INSERT INTO `progress` (`id`, `studentid`, `courseid`, `chapterid`, `examscore`) VALUES
	('1', '1', '2', '1', '2'),
	('2', '2', '3', '1', '3'),
	('3', '1', '1', '1', '92');
/*!40000 ALTER TABLE `progress` ENABLE KEYS */;

-- 导出  表 learningweb.relation 结构
...
-- 正在导出表  learningweb.relation 的数据：~10 rows (大约)
/*!40000 ALTER TABLE `relation` DISABLE KEYS */;
INSERT INTO `relation` (`id`, `courseid`, `frontcourseid`) VALUES
	('1', '1', '2'),
	('10', '14', '13'),
	('2', '4', '2'),
	('3', '3', '2'),
...
-- 正在导出表  learningweb.student 的数据：~4 rows (大约)
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` (`id`, `username`, `password`, `name`, `birthday`, `gendar`, `status`, `grade`, `email`, `major`, `picture`) VALUES
...
-- 正在导出表  learningweb.teacher 的数据：~7 rows (大约)
/*!40000 ALTER TABLE `teacher` DISABLE KEYS */;
INSERT INTO `teacher` (`id`, `username`, `name`, `password`, `gender`, `status`, `email`, `major`, `picture`, `introduction`) VALUES
	('1', 'root1', '王建', 'root', '女', '大学', '123', '计算机', NULL, '这个人很懒，什么也没有留下'),
