                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="container-fluid">
                                <div class="row-fluid">
                                    <div class="span12">
                                        <form action="../AdminTeaAdd" method="post">
                                            <fieldset>
                                                <legend>填写教师信息</legend>
                                                <table class="table">
                                                    <tr class="info">
                                                        <td>教师用户名</td>
                                                    ...
                                                    <tr class="info">
                                                        <td>密码</td>
                                                        <td><input type="text" name="Tpswd"/></td>
                                                    </tr>
                                                    <tr class="success">
                                                        <td>性别</td>
                                                        <td><select name="Tsex">
                                                    ...
                                                    <tr class="info">
                                                        <td>专业</td>
                                                        <td><input type="text" name="Tprofession"/></td>
                                                    </tr>
                                                    <tr class="success">
                                                        <td>学历</td>
