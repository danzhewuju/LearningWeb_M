                            ...
                            <form class="form-signin" name="form1" method="post" action="applyclass.do">
                                <fieldset>
                                    ...
                                    <div>
                                        ...
                                        <label>课程名:${cname} </label>
                                        <label>章节名：${chname}</label>
                                        <table class="table table-hover">

                                            <th>学生ID</th>
                                            <th>学生名字</th>
                                            <th>分数</th>
                                            <c:forEach var="progress" items="${plist}"
                                                       varStatus="status">
                                                ...
                                                <td>${progress.examscore}</td>

                                                <%--<td>  <a class="btn btn-success" href="T-marking.jsp?progress=${progress}">打分</a></td>--%>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                    </div>
                                    <a class="btn btn-danger" href="T-display2.jsp">返回</a>
                                </fieldset>
                            </form>
                        </div>
                    </div>
