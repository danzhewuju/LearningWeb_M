                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="container-fluid">
                                <div class="row-fluid">
                                    <div class="span12">
                                        <form action="../AdminRelUpd" method="post">
                                            <table class="table">
                                                ...
                                                <%
                                                    ...
                                                    if (list == null) {
                                                        ...
                                                        String rno = r.getId();
                                                        request.getSession().setAttribute("Relationid", rno);
                                                %>
                                                <tr class="success">
                                                    <td>序号</td>
                                                    <td><input type=text name=Cno value="<%=r.getId() %>"></td>
                                                </tr>
                                                <tr class="success">
                                                    <td>课程号</td>
                                                    <td><select name="Cid">
                                                        <option value="<%=r.getCourseid() %>"
                                                                selected><%=r.getCourseid() %>
                                                        </option>
                                                        <%
                                                            CourseDAO dao1 = new CourseDAO();
                                                            List<CoursePage> list1 = dao1.GetAll();
                                                        %>

                                                        <%for (CoursePage c : list1) { %>
                                                ...
                                                <tr class="success">
                                                    ...
                                                    <td><select name="Cpreid">
                                                        <option value="<%=r.getFrontcourseid() %>"
                                                                selected><%=r.getFrontcourseid() %>
                                                        </option>
