                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover table-striped">
                                ...
                                %>
                                <c:forEach var="t" items="${sessionScope.teacherlist}" varStatus="status">
                                    <tr class="error">
                                        <td>${t.username}</td>
                                        <td>${t.name}</td>
                                        <td>${t.gender}</td>
                                        ...
                                        <td><a href="Admin-TeaUpd.jsp?ID=${status.index}" class="btn btn-info  "
                                               role="button">修改</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
